...
export class MessagesService {
  ...
  constructor(private http: HttpClient) {
    ...
    getMessages() {
      //use http get
      this.http.get('https://leeya-cms-angular-default-rtdb.firebaseio.com/messages.json')
  ...
  addMessage(message: Message) {
    ...
    storeMessages() {
      ...
      this.http.put('https://leeya-cms-angular-default-rtdb.firebaseio.com/messages.json', messages, { headers: headers })
